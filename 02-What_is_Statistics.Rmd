...
This course is going to use R for the computations. Much of what we do could be computed using Excell or Google Sheets however R has ceertain advantages over these tools:
...
2. R is human readable - you can usually read a statement outloud and you will no exactly what it is doing.
3. R is free.
...
These variance is computing by taking the sum of the square differences between the data and the mean and then dividing that by number of items minus one; we will explain why this is what we divide by later in class.
...
Boxplots are a visual representation of the quadrant and median statistics for our data:
...
To interpret boxplots you should think in terms of quadrants:  Half of the data is in the box. Half of the data is to either side of the median.
