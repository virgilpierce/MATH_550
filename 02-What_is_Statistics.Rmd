...
An airline is running 655 aircraft in an hour with the engine used above. How many engine failures do we expect to happen in that hour?
...
A train company numbers its locomotives sequentially 1, 2, 3, ....  You happen to be standing at a station and you observe train number 65 go by. How many trains does the company own?
...
Because this is a course about data, we can look for data related to questions you have. 
