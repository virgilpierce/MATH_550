...
First we note that if $Y$ is a random variable then algebraic expressions for $Y$ are themselves random variables - though almost certainly with different distributions. 
